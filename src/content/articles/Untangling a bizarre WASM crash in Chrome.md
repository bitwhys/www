...
![Everybody loves BBCode!](https://bvisness.me/chrome-wasm-crash/images/bbcode-example.png)
...
![Nothing much to see on this profile...](https://bvisness.me/chrome-wasm-crash/images/empty-profile.png)
...
![A Chrome trace with one abnormally massive WASM-related function](https://bvisness.me/chrome-wasm-crash/images/beeg-flamegraph.png)
...
![More nested blocks than would ever fit on my screen](https://bvisness.me/chrome-wasm-crash/images/wasm-blocks.png)
...
![The editor does not crash now!](https://bvisness.me/chrome-wasm-crash/images/success.png)
